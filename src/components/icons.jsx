export const Icon = {
  ...
  Scale: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <path d="M7 21h10" stroke={color} strokeWidth="1.8" strokeLinecap="round"/>
      <path d="M5 6h14" stroke={color} strokeWidth="1.8" strokeLinecap="round"/>
      <path d="M5 6l-3 7h6z" stroke={color} strokeWidth="1.8" strokeLinejoin="round"/>
      <path d="M19 6l-3 7h6z" stroke={color} strokeWidth="1.8" strokeLinejoin="round"/>
    </svg>
  ),
}
